...
export function Sobre() {
  // const teamMembers = [
  //   { nome: "João Silva", cargo: "CEO & Fundador", foto: "https://images.unsplash.com/photo-1560250097-0b93528c311a?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" },
  //   { nome: "Maria Costa", cargo: "Diretora Comercial", foto: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" },
  //   { nome: "Carlos Santos", cargo: "Especialista em Importação", foto: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" },
  //   { nome: "Ana Oliveira", cargo: "Gestão e Pós-Venda", foto: "https://images.unsplash.com/photo-1580489944761-15a19d654956?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" }
  // ];
          ...
          <div className="max-w-7xl mx-auto mb-24">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="group bg-gray-50 dark:bg-[#121212] p-6 lg:p-8 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-sm transition-all duration-500 hover:-translate-y-3 hover:shadow-2xl hover:border-ja-blue/30 flex flex-col relative">
                <div className="text-5xl font-black text-gray-200 dark:text-gray-800 transition-colors duration-500 group-hover:text-ja-blue dark:group-hover:text-blue-500 mb-4">01</div>
                <h3 className="text-xl font-bold text-ja-dark dark:text-white mb-4">Revolucionar o Mercado</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed flex-1">Nascemos com a visão clara de transformar a compra de automóveis num processo simples. Queremos romper com o tradicional e estabelecer um novo padrão de confiança no setor automóvel.</p>
              </div>

              <div className="group bg-gray-50 dark:bg-[#121212] p-6 lg:p-8 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-sm transition-all duration-500 hover:-translate-y-3 hover:shadow-2xl hover:border-ja-blue/30 flex flex-col relative">
                <div className="text-5xl font-black text-gray-200 dark:text-gray-800 transition-colors duration-500 group-hover:text-ja-blue dark:group-hover:text-blue-500 mb-4">02</div>
                <h3 className="text-xl font-bold text-ja-dark dark:text-white mb-4">Transparência Total</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed flex-1">Acreditamos que a segurança do cliente está em primeiro lugar. Oferecemos um acompanhamento rigoroso e honesto em cada etapa, garantindo que sabe exatamente o que está a adquirir.</p>
              </div>

              <div className="group bg-gray-50 dark:bg-[#121212] p-6 lg:p-8 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-sm transition-all duration-500 hover:-translate-y-3 hover:shadow-2xl hover:border-ja-blue/30 flex flex-col relative">
                <div className="text-5xl font-black text-gray-200 dark:text-gray-800 transition-colors duration-500 group-hover:text-ja-blue dark:group-hover:text-blue-500 mb-4">03</div>
                <h3 className="text-xl font-bold text-ja-dark dark:text-white mb-4">Soluções Chave-na-Mão</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed flex-1">Seja através do nosso stock ou no serviço especializado de importação, tratamos de toda a burocracia e logística. O nosso objetivo é eliminar as complicações para o cliente.</p>
              </div>

              <div className="group bg-gray-50 dark:bg-[#121212] p-6 lg:p-8 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-sm transition-all duration-500 hover:-translate-y-3 hover:shadow-2xl hover:border-ja-blue/30 flex flex-col relative">
                <div className="text-5xl font-black text-gray-200 dark:text-gray-800 transition-colors duration-500 group-hover:text-ja-blue dark:group-hover:text-blue-500 mb-4">04</div>
                <h3 className="text-xl font-bold text-ja-dark dark:text-white mb-4">Experiência do Cliente</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed flex-1">Mais do que vender viaturas, focamo-nos na satisfação de quem confia em nós. Trabalhamos para que a única preocupação do cliente seja desfrutar da sua nova viatura com total tranquilidade.</p>
              </div>
            </div>
          </div>
        </ScrollReveal>

        {/* ================= SECÇÃO DA EQUIPA (COMENTADA TEMPORARIAMENTE) ================= */}
        {/*
        <ScrollReveal>
          <div>
            <div className="text-center mb-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 max-w-6xl mx-auto">
              {teamMembers.map((member, index) => (
                <div key={index} className="bg-gray-50 dark:bg-[#121212] rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-800 flex flex-col group">
                  <div className="aspect-[4/5] w-full overflow-hidden relative">
                    <img src={member.foto} alt={member.nome} className="w-full h-full object-cover object-top group-hover:scale-105 transition-transform duration-700" />
                  </div>
                  <div className="p-6 text-center flex flex-col justify-center bg-white dark:bg-[#18181b] z-10 -mt-2 rounded-t-2xl relative border-t border-gray-50 dark:border-gray-800">
                    <h3 className="text-xl font-bold text-ja-dark dark:text-white mb-1">{member.nome}</h3>
                    <p className="text-sm font-bold text-teal-600 dark:text-teal-400">{member.cargo}</p>
                  </div>
                </div>
              ))}
            </div>
